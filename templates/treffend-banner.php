 ...
 *
 * HOWEVER, on occasion Treffend will need to update template files and you
 * (the theme developer) will need to copy the new files to your theme to
 * maintain compatibility. We try to do this as little as possible, but it does
 * happen. When this occurs the version of the template file will be bumped and
 * the readme will list any important changes.
 * 
 * For the working of the tempkate, please do not remove the lines that have an ID set on it. Because the plugin uses these ID's to interact with the buttons.
 *
 * @see https://trefdev.nl/treffendcookies/docs/templating/
